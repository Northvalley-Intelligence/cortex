/**
 * VENDORED VERBATIM from retail-search/src/evaluation/metrics.js
 *
 * Source: /Users/feroshjacob/code/retail-search/src/evaluation/metrics.js
 * Vendored: 2026-07-16 (GEN-001)
 * Upstream SHA256: 2f8113d892d385198051f80e9017e336dde5c292bfe360948f540c21512737bb
 *
 * DO NOT EDIT THIS FILE. Edit upstream and re-vendor.
 *
 * Why vendored rather than reimplemented: Generation 0 reviewed this implementation and found
 * it textbook-correct (log2 discount, ideal DCG sorted by gain descending and truncated to
 * the same k, idealDcg==0 guarded). MISSION.md:93 names plausible-but-wrong NDCG as a real
 * risk, and the surest way to create that risk is a second, subtly-different NDCG in the
 * portfolio. So Cortex computes no ranking metric of its own -- it produces graded judgments
 * and hands them to this.
 *
 * Why vendored rather than imported across repos: a relative path into a sibling repo is a
 * hard filesystem dependency that breaks silently when either repo moves. test/ndcg.test.mjs
 * detects drift against upstream whenever it is present.
 */
